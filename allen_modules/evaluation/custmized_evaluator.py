        ...
        with torch.no_grad():
            ...
            for batch in generator_tqdm:
                ...
                if predictions_file is not None:
                    ...
                    if "predicted_text" in output_dict:
                    ...
                    elif "predicted_tokens" in output_dict:
                        ...
                        # For case of classification
                        for idx in range(len(output_dict["tokens"])):
                            source_text = batch["metadata"][idx]["source_text"]
                            gold_label = batch["metadata"][idx]["label"]
                            pred_label = output_dict["label"][idx]
                            # print(source_text, gold_label, pred_label)
                            # raise NotImplementedError
                            line = "{}\t{}\t{}\n".format(source_text, gold_label, pred_label)
