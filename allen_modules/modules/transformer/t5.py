...
#         # if self.test_dropout is not None and self.eval():
#         #     hidden_states = F.dropout(hidden_states, p=self.test_dropout, training=True)
#             # print("Using test dropout")
#             # raise NotImplementedError
#
...
#         # if self.test_dropout > 0.0 and self.eval():
#         #     raise NotImplementedError
#             # hidden_states = F.dropout(hidden_states, p=self.test_dropout, training=True)
#
#         # Add last layer
...
#             blocks.append(block)
#         # return cls(token_embeddings, blocks, final_layer_norm=final_layer_norm, dropout=dropout, test_dropout=test_dropout)
...
class T5(TransformerModule, Registrable):
    ...
    def __init__(
        ...
        # print(self.beam_search.sampler.temperature)
    ...
    def _from_config(cls, config: "PretrainedConfig", **kwargs):
        # test_dropout = kwargs.pop("test_dropout", 0.0)
        # raise NotImplementedError
        attention_kwargs = {
